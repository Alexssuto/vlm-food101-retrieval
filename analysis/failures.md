...
| [failure_1.png](images/failure_1.png) | beignets   |donuts           |    Beignets are often square fried doughs, where as donuts are more circular.                          |    Similar-looking foods      |
| [failure_2.png](images/failure_2.png) | beignets   | churros         |  The dipping sauces resemble the sauces used on churros. |    Multiple foods in frame      |
| [failure_3.png](images/failure_3.png) | beignets   | bread_pudding   |   Bread pudding is often served with ice cream therefore confusion  | Multiple foods in frame         |
| [failure_4.png](images/failure_4.png) | beignets   |donuts           |Beignets are often square fried doughs, where as donuts are more circular.                              |Similar-looking foods          |
| [failure_5.png](images/failure_5.png) | beignets   | churros         | The dipping sauces resemble the sauces used on churros.                             | Multiple foods in frame          |
| [failure_6.png](images/failure_6.png) | beignets   | takoyaki        | The unusual shapes and presentation resembles that of takoyaki.  | Unusual presentation / style  Similar-looking foods        |
| [failure_7.png](images/failure_7.png) | beignets   | churros         | The dipping sauces resemble the sauces used on churros. |    Multiple foods in frame      |
| [failure_8.png](images/failure_8.png) | beignets   | churros         |The dipping sauces resemble the sauces used on churros. |    Multiple foods in frame      |
| [failure_9.png](images/failure_9.png) | beignets   | eggs_benedict   | The beignets are placed just like how egg benedicts would be presented.                            |   Unusual presentation / style       |
